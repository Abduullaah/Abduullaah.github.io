...
export const icons = {
  ...
  mic:       P('<rect x="6" y="1.8" width="4" height="7.5" rx="2"/><path d="M3.8 7.5a4.2 4.2 0 0 0 8.4 0M8 11.7v2.5M5.8 14.2h4.4"/>'),
  ledger:    P('<rect x="2.5" y="2.5" width="11" height="11" rx="1.5"/><path d="M5 6h6M5 8.5h6M5 11h3.5"/>'),
  settings:  P('<circle cx="8" cy="8" r="2"/><path d="M9.25 2.2l.28 1.38c.4.15.77.37 1.1.64l1.34-.45 1.25 2.17-1.05.94a4.7 4.7 0 0 1 0 1.24l1.05.94-1.25 2.17-1.34-.45c-.33.27-.7.49-1.1.64L9.25 13.8h-2.5l-.28-1.38a4.4 4.4 0 0 1-1.1-.64l-1.34.45-1.25-2.17 1.05-.94a4.7 4.7 0 0 1 0-1.24l-1.05-.94 1.25-2.17 1.34.45c.33-.27.7-.49 1.1-.64L6.75 2.2z"/>'),
